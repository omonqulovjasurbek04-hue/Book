    ...
    <section className="w-full max-w-[1536px] mx-auto">
                ...
                <div className={`group relative w-full h-96 lg:h-[480px] flex justify-center items-center transition-opacity duration-500 ${isAnimating ? 'opacity-50' : 'opacity-100'} perspective-[1200px]`}>
                  ...
                  <div className="absolute bottom-6 left-1/2 w-[110%] max-w-[600px] h-[110px] lg:h-[130px] -translate-x-1/2 pointer-events-none z-0">
                    <svg viewBox="0 0 400 100" className="h-full w-full" preserveAspectRatio="none">
                      <path d="M 5 55 C 5 20, 80 5, 200 5 C 320 5, 395 20, 395 55" fill="none" stroke="rgba(255,255,255,0.9)" strokeWidth="1.5" />
                      <path d="M 5 55 C 5 80, 50 92, 110 95" fill="none" stroke="rgba(255,255,255,0.9)" strokeWidth="1.5" />
                      <path d="M 102 89 L 112 95 L 102 101" fill="none" stroke="rgba(255,255,255,0.9)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                      <path d="M 290 95 C 350 92, 395 80, 395 55" fill="none" stroke="rgba(255,255,255,0.9)" strokeWidth="1.5" />
                    </svg>
                  </div>

                  <div className="absolute top-[2%] left-[0%] lg:-left-4 z-40 transition-opacity duration-300 opacity-100 group-hover:opacity-0 pointer-events-none">
                    <div className="relative">
                      <div className="rounded-[14px] bg-white px-5 py-3 shadow-[0_15px_30px_rgba(0,0,0,0.15)] flex flex-col items-center">
                        <p className="text-[#a832d2] text-9 font-extrabold italic tracking-tighter leading-none mb-1">10%</p>
                        <p className="text-[#a832d2] text-xs font-bold uppercase tracking-widest leading-none mt-1">CHEGIRMA</p>
                      </div>
                      
                      <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[12px] border-r-[12px] border-t-[14px] border-l-transparent border-r-transparent border-t-white"></div>
                    </div>
                  </div>

                  <div className="absolute bottom-[25%] left-[-15%] z-40 transition-opacity duration-300 opacity-0 group-hover:opacity-100 pointer-events-none">
                    <div className="relative">
                      <div className="bg-white rounded-2xl px-6 py-4 flex flex-col items-start justify-center shadow-[0_15px_30px_rgba(0,0,0,0.15)]">
                        <p className="text-[#997bb3] text-base font-medium italic line-through decoration-[#997bb3] leading-none mb-2 tracking-wide">650.000 som</p>
                        <p className="text-[#4b2d75] text-6 font-black italic leading-none tracking-wide">400.000 som</p>
                      </div>
                      <div className="absolute bottom-5 -right-3 w-0 h-0 border-t-2.5 border-b-2.5 border-l-[16px] border-t-transparent border-b-transparent border-l-white"></div>
                    </div>
                  </div>
      ...
      <div className="md:hidden px-4">
        ...
        <div className="flex flex-col items-center pt-4 pb-2">
          <div className="relative w-full max-w-80">
            ...
            <div className={`group relative w-full h-[360px] flex justify-center items-center transition-opacity duration-500 ${isAnimating ? 'opacity-50' : 'opacity-100'} perspective-[1000px]`}>
              ...
              <div className="absolute top-[2%] left-[2%] z-40 transition-opacity duration-300 opacity-100 group-hover:opacity-0 pointer-events-none">
                <div className="relative">
                  <div className="rounded-[14px] bg-white px-4 py-2 shadow-[0_10px_20px_rgba(0,0,0,0.15)] flex flex-col items-center">
                    <p className="text-[#a832d2] text-[28px] font-extrabold italic tracking-tighter leading-none mb-1">10%</p>
                    <p className="text-[#a832d2] text-2.5 font-bold uppercase tracking-widest leading-none mt-0.5">chegirma</p>
                  </div>
                  <div className="absolute -bottom-2.5 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[8px] border-r-[8px] border-t-2.5 border-l-transparent border-r-transparent border-t-white"></div>
                </div>
              </div>

              <div className="absolute bottom-[28%] left-[-2%] z-40 transition-opacity duration-300 opacity-0 group-hover:opacity-100 pointer-events-none">
                <div className="relative">
                  <div className="bg-white rounded-[16px] px-4 py-3 flex flex-col items-start justify-center shadow-[0_10px_20px_rgba(0,0,0,0.15)]">
                    <p className="text-[#997bb3] text-sm font-medium italic line-through decoration-[#997bb3] leading-none mb-1.5 tracking-wide">650.000 som</p>
                    <p className="text-[#4b2d75] text-5 font-black italic leading-none tracking-wide">400.000 som</p>
                  </div>
                  <div className="absolute bottom-4 -right-2 w-0 h-0 border-t-[8px] border-b-[8px] border-l-[12px] border-t-transparent border-b-transparent border-l-white"></div>
                </div>
              </div>
        ...
        <div className="pt-5 pb-4">
          <h1 className="text-gray-900 text-[1.55rem] font-bold leading-[1.25] mb-3 uppercase">
            Angelfaces to'plamini{' '}
            <span className="text-[#FF8A65]">10%</span>{' '}
            chegirma bilan sotib oling.
          </h1>
